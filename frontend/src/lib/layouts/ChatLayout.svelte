...
<div class="flex flex-col md:flex-row bg-base-200 h-full overflow-hidden">
  ...
  <div class="flex flex-col w-full h-full md:gap-2 md:p-2 md:pt-0 overflow-hidden">
    <main class="flex-grow h-full md:rounded-lg md:border bg-stone-50 overflow-hidden">
      <Chat
        {assistants}
