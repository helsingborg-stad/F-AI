<script module lang="ts">
  ...
  import { mockOnlyAssistants, mockTitleAndAssistants } from '$stories/assets/mockData/assistantPicker.ts'

  const { Story } = defineMeta({
    title: 'Components/Menu/AssistantPicker',
    component: AssistantPicker,
    parameters: {
      layout: 'centered',
    },
  })
