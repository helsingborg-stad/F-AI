...
class Settings(BaseSettings, extra=Extra.ignore):
    ...
    MESSAGE_BROKER_TYPE: Literal['memory', 'redis_queue'] = 'redis_queue'
    MESSAGE_BROKER_HOST: str = 'localhost'
    MESSAGE_BROKER_PORT: int = 6379
    MESSAGE_BROKER_USERNAME: SecretStr | None = None
    MESSAGE_BROKER_PASSWORD: SecretStr | None = None
    MESSAGE_BROKER_TASK_FUNC: str = 'worker_src.task.external_api_call'
    MESSAGE_BROKER_REST_BASE_URL: str = 'http://host.docker.internal:8000'
